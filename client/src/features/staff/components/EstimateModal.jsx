...
const SearchableSelect = ({
  ...
  const inputPadding =
    size === "large" ? "py-3.5 sm:py-4 pl-11" : "py-3 lg:py-2.5 pl-9";
  const iconLeft = size === "large" ? "left-4" : "left-3";
  const iconSize = size === "large" ? 16 : 14;
  const listPadding = size === "large" ? "p-4" : "p-3 sm:p-4";
      ...
      <AnimatePresence>
        {isOpen && (
          <motion.div
            ...
            exit={{ opacity: 0, y: 5 }}
            className={`absolute top-full left-0 right-0 mt-1 bg-white dark:bg-slate-800 border border-slate-200 dark:border-slate-700 ${roundedBox} shadow-2xl max-h-48 sm:max-h-64 overflow-y-auto custom-scrollbar z-50`}
          >
            {filteredOptions.length > 0 ? (
              ...
              <div className="p-4 sm:p-5 text-center text-xs font-medium text-slate-500 uppercase tracking-widest">
    ...
    <AnimatePresence>
      {isOpen && (
        <div className="fixed inset-0 z-[60] flex items-center justify-center p-4 sm:p-6 bg-slate-900/60 backdrop-blur-sm">
          ...
          >
            {/* Header */}
            <div className="flex justify-between items-center p-5 sm:p-8 pb-4 border-b border-slate-100 dark:border-slate-700/50">
            ...
            {/* Body */}
            <div className="px-4 sm:px-8 py-6 overflow-y-auto custom-scrollbar flex-1 space-y-6">
              {validationError && (
                ...
                >
                    ...
                    <div className="grid grid-cols-1 md:grid-cols-2 gap-4 sm:gap-5 relative">
                      ...
                      <div>
                        ...
                        <input
                          ...
                          className="w-full px-4 py-3.5 sm:py-4 bg-white dark:bg-slate-900 border border-slate-200 dark:border-slate-700 rounded-xl sm:rounded-2xl text-xs font-bold text-slate-900 dark:text-white focus:outline-none focus:border-amber-500 focus:ring-1 shadow-sm transition-all"
                        />
                      </div>
                    </div>
                  </section>
                  ...
                  <section className="relative z-[50] bg-slate-50 dark:bg-slate-900/50 p-4 sm:p-6 rounded-[20px] sm:rounded-[24px] border border-slate-200 dark:border-slate-700">
                        ...
                        >
                          ...
                          <div className="w-full lg:w-32 shrink-0">
                            <select
                              ...
                              className="w-full py-3 lg:py-2.5 px-3 bg-slate-50 dark:bg-slate-900 border border-slate-200 dark:border-slate-600 rounded-lg sm:rounded-xl text-xs font-bold text-slate-700 dark:text-slate-300 focus:outline-none focus:border-amber-500"
                            >
                          ...
                          <div className="flex items-center justify-between gap-2 sm:gap-3 w-full lg:w-auto shrink-0 pt-2 lg:pt-0 border-t border-slate-100 dark:border-slate-700/50 lg:border-none mt-1 lg:mt-0">
                            <div className="flex-1 lg:flex-none lg:w-20">
                              <input
                                ...
                                className="w-full py-3 lg:py-2.5 px-3 bg-slate-50 dark:bg-slate-900 border border-slate-200 dark:border-slate-600 rounded-lg sm:rounded-xl text-xs font-bold text-center text-slate-900 dark:text-white focus:outline-none focus:border-amber-500"
                              />
                            </div>
                            <div className="flex-1 lg:flex-none lg:w-28 relative">
                              ...
                              <input
                                ...
                                className="w-full pl-7 py-3 lg:py-2.5 bg-amber-50 dark:bg-amber-500/10 border border-amber-200 dark:border-amber-500/20 rounded-lg sm:rounded-xl text-xs font-bold text-amber-700 dark:text-amber-400 focus:outline-none focus:border-amber-500"
                              />
                            </div>
                            <button
                              type="button"
                    ...
                    <button
                      type="button"
                      onClick={addLineItem}
                      className="mt-4 text-[10px] font-black uppercase tracking-widest text-blue-600 dark:text-blue-400 flex items-center justify-center w-full sm:w-auto gap-1.5 hover:bg-blue-50 dark:hover:bg-blue-500/10 px-4 py-3 sm:py-2.5 rounded-xl transition-colors border border-dashed border-blue-200 dark:border-blue-500/30"
                    >
                  ...
                  <div className="grid grid-cols-1 lg:grid-cols-2 gap-5 sm:gap-6 relative z-[40]">
            ...
            <div className="p-4 sm:p-6 border-t border-slate-100 dark:border-slate-700/50 bg-slate-50 dark:bg-slate-800/30 shrink-0">
              <button
                ...
                className="w-full py-3.5 sm:py-4 bg-amber-500 hover:bg-amber-600 text-slate-900 font-black rounded-xl text-[10px] sm:text-xs uppercase tracking-widest transition-all active:scale-[0.98] flex justify-center items-center gap-2 shadow-lg shadow-amber-500/20 disabled:opacity-50"
              >
                {isSubmitting ? (

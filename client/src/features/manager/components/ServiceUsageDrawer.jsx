...
import { X, Wrench, Loader2, Activity, FileText } from "lucide-react";
    ...
    <AnimatePresence>
      {isOpen && (
        <div className="fixed inset-0 z-[100] flex justify-end">
          ...
          >
            <header className="flex justify-between items-center px-6 py-5 sm:px-8 sm:py-6 border-b border-slate-200 dark:border-slate-800 bg-white dark:bg-slate-900 shrink-0 z-10 shadow-sm">
            ...
            <div className="flex-1 overflow-y-auto custom-scrollbar px-6 py-6 sm:px-8 sm:py-8 space-y-6 bg-slate-50/50 dark:bg-transparent">
              {loading && (
              ...
              {!loading && !error && (
                <section className="bg-white dark:bg-slate-800 p-6 rounded-[20px] border border-slate-200 dark:border-slate-700 shadow-sm flex flex-col">
                  <h3 className="text-[10px] font-black uppercase tracking-widest text-slate-500 mb-5 flex items-center gap-2">
                    <FileText size={16} className="text-blue-500" /> Billing
                    History
                  </h3>

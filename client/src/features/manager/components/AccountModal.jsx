...
import { X, BookOpen, AlertCircle, Loader2, Save } from "lucide-react";
              ...
              >
                ...
                <div className="flex items-center p-4 bg-slate-50 dark:bg-slate-900/50 rounded-xl border border-slate-200 dark:border-slate-700">
                  ...
                  <label
                    ...
                    className="ml-3 text-xs font-bold text-slate-700 dark:text-slate-300 cursor-pointer uppercase tracking-wider"
                  >
                    Enable Automated VAT Posting
                  </label>
                </div>
              </form>
            </div>

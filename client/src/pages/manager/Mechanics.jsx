  ...
  return (
    <div className="space-y-8 animate-in fade-in duration-700 relative pb-10">
            ...
            <tbody className="divide-y divide-slate-50 dark:divide-white/5">
              {filteredMechanics.map((mech) => (
                ...
                >
                  ...
                  {/* Skill Badges */}
                  <td className="px-8 py-5 max-w-[250px] overflow-hidden">
                    <div className="flex flex-wrap gap-1.5">
                      {mech.skills && mech.skills.length > 0 ? (
                        mech.skills.map((skill, idx) => (
                          <span
                            key={idx}
                  ...
                  <td colSpan="5" className="px-8 py-12 text-center">
                    <div className="inline-flex flex-col items-center justify-center text-slate-400">
                      ...
                      <p className="text-sm font-bold">
                        No mechanics enrolled yet.
                      </p>
                      <p className="text-xs mt-1">
                        Click "Enroll Mechanic" to add personnel to the roster.
                      </p>
                    </div>
                  </td>
                </tr>
      ...
      <MechanicModal
        ...
        branches={branches} // Pass fetched branches to modal
      />
    </div>
  );
};

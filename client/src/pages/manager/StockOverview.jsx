...
const StockOverview = () => {
  ...
  const [selectedBranch, setSelectedBranch] = useState(""); // empty string = 'All Branches'
  ...
  // Load Inventory data when branch selection changes
          ...
          <table className="w-full text-left whitespace-nowrap">
            <thead>
              <tr className="bg-slate-50 dark:bg-black/20 text-[10px] font-black uppercase text-slate-400 tracking-widest border-b border-slate-100 dark:border-white/5">
                ...
                <th className="px-8 py-5">Financials (Cost / Sell)</th>
            ...
            <tbody className="divide-y divide-slate-50 dark:divide-white/5">
              {filteredItems.map((item) => {
                ...
                const isLowStock = !isConsolidated && item.is_low_stock; // Health logic only applies to specific branches
                ...
                return (
                  ...
                  >
                    ...
                    <td className="px-8 py-4 text-center">
                      <div
                        className={`inline-flex items-center gap-1.5 px-3 py-1.5 rounded-lg border font-mono text-xs font-black ${
                          isOutOfStock
